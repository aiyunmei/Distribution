      ...
      <el-collapse>
        <el-collapse-item name="1">
          ...
          <div class="item-search-input">
            <el-row>
              <el-col :span="4">
                <el-input v-model="searchData.comName" placeholder="公司名称" class="item-search-input-l" @keyup.enter.native="search"></el-input>
              </el-col>
              <el-col :span="8">
...
<script type="text/ecmascript-6">
  ...
  export default {
    ...
    methods: {
      Result (formData) { // 初始化
        let that = this
        let url = that.$api.reportCompany.result
